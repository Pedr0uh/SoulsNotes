...
fun UndertaleSondsScreen(NavController: NavHostController) {
    ...
    val musicList = listOf(
        ...
        MusicItem(
            "TobyFox - WaterFall (Orquestral Cover)",
            RawResourceDataSource.buildRawResourceUri(R.raw.waterfall_tema)
        ),
        MusicItem(
            "TobyFox - FallenDown (Peaceful River and Birdsong Version)",
    ...
    val exoPlayer = remember {
        ExoPlayer.Builder(context).build().apply {
            val videoUri =
                RawResourceDataSource.buildRawResourceUri(R.raw.frisk_waterfall) //armazena o video
